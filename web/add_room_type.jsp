        ...
        <div class="content-container">
            ...
            <div class="register-form-container">
                <form id="registration" method="post" action="addRoomType" onsubmit="return formValidation()">
                    ...
                    <div class="input-box">
                        <input type="text" id="RoomTypeID" name="RoomTypeName" required>
                        <label>Room Type Name</label>
                    </div>
                    <button class="register-button" style="font-size:24px" type="submit" name="submit">Add Room Type</button>
                </form>
            </div>
        </div>
    </div>
