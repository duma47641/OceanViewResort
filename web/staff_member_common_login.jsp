...
<body>
        ...
        <div class="content-container">
            ...
            <div class="register-form-container">
                <form id="registration" method="post" onsubmit="return formValidation()">
                    <h1>STAFF MEMBER COMMON LOGIN</h1>
                    <div class="input-box">
                    ...
                    <button class="register-button" style="font-size:24px" type="submit" name="submit">Staff Member Common Login</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        if (email == "staffmembercommonlogin@oceanviewresort.lk" && password == "12345") {
            alert("Staff Member Common Login Successful.");
            window.location='staff_member_login.jsp';
            return false;
        }
        else {
            alert("Staff Member Common Login Failed!");
            return false;
        }
    }
    </script>
