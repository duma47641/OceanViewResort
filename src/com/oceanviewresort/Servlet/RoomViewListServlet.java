...
@WebServlet("/roomViewList")
public class RoomViewListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("roomViewList", rooms);
        request.setAttribute("typeList", types);

        request.getRequestDispatcher("view_room.jsp")
